...
export const data = {
    ...
    sticks: [
        ...
        new Stick( "Hitman's pistol", "A really cool stick that looks like a pistol.", "https://utfs.io/f/14d3c81f-4ef8-4460-a55f-1a47e2d2eda6-jm13wm.png", 70, "short", "curved", "Pine", "light", "2024-10-04T14:09:30", "2024-10-04T14:09:40"),
...
new Bid(data.users[0].id, data.sticks[1].id, 700, true);
